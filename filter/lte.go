...
// LteInt64 composes 'equal' operation from int64 value.
// Result is equivalent to: field == value.
func LteInt64(field string, value int64) Expr {
	return Expr{field: comparison{Lte: value}}
}

// LteInt32 composes 'equal' operation from int32 value.
// Result is equivalent to: field == value.
func LteInt32(field string, value int32) Expr {
	return Expr{field: comparison{Lte: value}}
}

// LteInt composes 'equal' operation from int value.
// Result is equivalent to: field == value.
func LteInt(field string, value int) Expr {
	return Expr{field: comparison{Lte: value}}
}

// LteString composes 'equal' operation from string value.
// Result is equivalent to: field == value.
func LteString(field string, value string) Expr {
	return Expr{field: comparison{Lte: value}}
}

// LteBytes composes 'equal' operation from []byte value.
// Result is equivalent to: field == value.
func LteBytes(field string, value []byte) Expr {
	return Expr{field: comparison{Lte: value}}
}

// LteFloat32 composes 'equal' operation from float32 value.
// Result is equivalent to: field == value.
func LteFloat32(field string, value float32) Expr {
	return Expr{field: comparison{Lte: value}}
}

// LteFloat64 composes 'equal' operation from float64 value.
// Result is equivalent to: field == value.
func LteFloat64(field string, value float64) Expr {
	return Expr{field: comparison{Lte: value}}
}

// LteTime composes 'equal' operation. from time.Time value.
// Result is equivalent to: field == value.
func LteTime(field string, value time.Time) Expr {
	return Expr{field: comparison{Lte: value}}
}

// LteUUID composes 'equal' operation. from uuid.UUID value.
// Result is equivalent to: field == value.
